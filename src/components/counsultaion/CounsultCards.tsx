...
const cardData = [
  {
    ...
    icon: <FaVideo className="text-4xl sm:text-5xl text-[#1ec258]" />,
  },
  {
    ...
    icon: <FaPhoneAlt className="text-4xl sm:text-5xl text-[#1ec258]" />,
  },
  {
    ...
    icon: <FaLinkedin className="text-4xl sm:text-5xl text-[#1ec258]" />,
  },
  {
    ...
    icon: <FaYoutube className="text-4xl sm:text-5xl text-[#1ec258]" />,
  },
];
    ...
    <section className="bg-black py-10 px-4">
      <div className="max-w-5xl  mx-auto grid grid-cols-1 md:grid-cols-1 gap-6"data-aos="fade-up" >
        {cardData.map((card, i) => (
          <div
            key={i}
            className="border border-white rounded-xl p-6 bg-black shadow-md transition-transform transform hover:scale-101 hover:shadow-[0_0_8px_#1ec258] flex flex-col items-start py-10"
          >
            <div className="mb-4">{card.icon}</div>
            <h2 className="text-2xl sm:text-5xl font-bold text-gray-300 mb-3">{card.title}</h2>
