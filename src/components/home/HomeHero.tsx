     ...
     <div className="absolute h-[70.5vh] md:h-[110.5vh] inset-0 bg-gradient-to-r from-black/100 via-black/40 to-transparent"></div>
      ...
      <div className="relative flex-1 px-2 sm:px-14">
          ...
          <div className="block sm:flex space-y-2 text-center sm:text-start sm:space-x-4">
            ...
            <button className="bg-transparent border border-white sm:border-[#1ec258] hover:bg-[#1ec258] hover:text-white text-white sm:text-[#1ec258] font-bold py-3 px-4 sm:px-8 rounded-full text-md sm:text-xl">
